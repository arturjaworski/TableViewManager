...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/TableViewManager"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Artur Jaworski" => "kontakt@arturjaworski.pl" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/TableViewManager.git", :tag => s.version.to_s }
  ...
  s.resource_bundles = {
    'TableViewManager' => ['Pod/Assets/*.png']
  }
